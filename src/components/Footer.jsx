      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <h1 className="mt-4 text-[#d8ebbdb6]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-16 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-sm">
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">
                  Components
                </li>
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">
                  Theme Palletes
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-sm">
                ...
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">Blogs</li>
              </ul>
            </div>
            <div>
              <h2 className="mb-2 text-lg font-semibold ">Organization</h2>
              <ul className=" font-sm">
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">About</li>
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">
                  Privacy Policy
                </li>
                <li className="mb-2 cursor-pointer text-[#d8ebbdb6]">
        ...
        <hr className="my-6 border-gray-200 sm:mx-auto dark:border-[#d8ebbd7d] lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center ">
            © 2023 Kaleido. All Rights Reserved.
          </span>
